...
const Navbar = () => {
  ...
  return (
    <nav style={{ backgroundImage: `url(${BackgroundImage})` }}  className="bg-whitefixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
      ...
      >
        <span className="flex">
          ...
          Get started <IoIosArrowUp
 className="ml-2 mt-0.5 h-[20px] w-[24px]" />
        </span>
      </button>

      {showDropdown && (
        <div
          className="z-10 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-40  dark:divide-gray-600 absolute top-0 right-0 mt-14 "
        >
          <ul className="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
            <li>
              <a href="#" className="block px-4 py-2 text-[#184623] dark:hover:text-emerald-600"> <span className="flex">
         ...
         User Dashboard
            ...
            <li>
              <a href="#" className="block px-4 py-2   text-[#184623] dark:hover:text-emerald-600">Disconnect</a>
            </li>
          </ul>
         {/* new  */}
        </div>
